...
describe("ListingForm", () => {
  ...
  it("loads create mode categories and submits the canonical create payload", async () => {
    ...
    expect(screen.getByRole("option", { name: /house \/ villa/i })).toBeInTheDocument();
  ...
  it("hydrates edit mode from seller-owned listing data and saves updates", async () => {
    ...
    render(<ListingForm initialListing={initialListing} listingId="listing-7" mode="edit" />);
  ...
  it("shows backend image upload errors clearly", async () => {
    ...
    render(<ListingForm initialListing={buildListing()} listingId="listing-7" mode="edit" />);
