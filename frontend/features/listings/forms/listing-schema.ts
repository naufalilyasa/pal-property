...
export const listingFormSchema = z.object({
  ...
  location_province_code: z.string().trim().min(1, "Province is required."),
  location_city: z.string().optional(),
  location_city_code: z.string().trim().min(1, "City is required."),
  location_district: z.string().optional(),
  location_district_code: z.string().trim().min(1, "District is required."),
  location_village: z.string().optional(),
  location_village_code: z.string().trim().min(1, "Village is required."),
